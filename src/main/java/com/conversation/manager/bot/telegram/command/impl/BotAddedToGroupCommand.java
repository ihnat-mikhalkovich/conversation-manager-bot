...
import static com.conversation.manager.bot.telegram.command.BotCommandType.BOT_ADDED_TO_GROUP;

@Component
public class BotAddedToGroupCommand extends AbstractBotCommand {
